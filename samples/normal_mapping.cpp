...
int main() {
  ...
  std::string normal_mapping_vertex_shader = shader_path + "/normal_mapping.vs";
  std::string normal_mapping_fragment_shader =
      shader_path + "/normal_mapping.fs";
  Shader shader(normal_mapping_vertex_shader.c_str(),
                normal_mapping_fragment_shader.c_str());

  // load textures
  std::string resource_path(RESOURCE_PATH);
  unsigned int diffuseMap =
      loadTexture((resource_path + "/brickwall.jpg").c_str());
  unsigned int normalMap =
      loadTexture((resource_path + "/brickwall_normal.jpg").c_str());
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // rotate the quad to show normal
