...
int main() {
  ...
  std::string asteroid_vertex_shader = shader_path + "/asteroids.vs";
  std::string asteroid_fragment_shader = shader_path + "/asteroids.fs";
  std::string planet_vertex_shader = shader_path + "/planet.vs";
  std::string planet_fragment_shader = shader_path + "/planet.fs";
  Shader asteroidShader(asteroid_vertex_shader.c_str(),
                        asteroid_fragment_shader.c_str());
  Shader planetShader(planet_vertex_shader.c_str(),
                      planet_fragment_shader.c_str());

  // load models
  std::string resource_path(RESOURCE_PATH);
  Model rock(resource_path + "/objects/rock/rock.obj");
  Model planet(resource_path + "/objects/planet/planet.obj");
  ...
  for (unsigned int i = 0; i < amount; i++) {
    ...
    // keep height of asteroid field smaller
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // note: we also made the textures_loaded vector public
