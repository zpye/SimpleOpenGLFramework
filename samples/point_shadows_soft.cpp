...
int main() {
  ...
  std::string point_shadows_vertex_shader = shader_path + "/point_shadows.vs";
  std::string point_shadows_fragment_shader = shader_path + "/point_shadows.fs";
  std::string point_shadows_depth_vertex_shader =
      shader_path + "/point_shadows_depth.vs";
  std::string point_shadows_depth_fragment_shader =
      shader_path + "/point_shadows_depth.fs";
  std::string point_shadows_depth_geometry_shader =
      shader_path + "/point_shadows_depth.gs";
  Shader shader(point_shadows_vertex_shader.c_str(),
                point_shadows_fragment_shader.c_str());
  Shader simpleDepthShader(point_shadows_depth_vertex_shader.c_str(),
                           point_shadows_depth_fragment_shader.c_str(),
                           point_shadows_depth_geometry_shader.c_str());

  // load textures
  std::string resource_path(RESOURCE_PATH);
  unsigned int woodTexture = loadTexture((resource_path + "/wood.png").c_str());
...
void renderScene(const Shader& shader) {
  ...
  glDisable(GL_CULL_FACE);  // note that we disable culling here since we render
